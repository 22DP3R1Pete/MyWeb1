                ...
                <form action="{{ route('admin.exercises.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500 focus:ring-opacity-50" required>
                            @error('name')
                        ...
                        <div>
                            ...
                            <select name="equipment_needed" id="equipment_needed" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500 focus:ring-opacity-50" required>
                                ...
                                <option value="None" {{ old('equipment_needed') == 'None' ? 'selected' : '' }}>{{ __('None (Bodyweight)') }}</option>
                                <option value="Dumbbells" {{ old('equipment_needed') == 'Dumbbells' ? 'selected' : '' }}>{{ __('Dumbbells') }}</option>
                                <option value="Barbell" {{ old('equipment_needed') == 'Barbell' ? 'selected' : '' }}>{{ __('Barbell') }}</option>
                                <option value="Kettlebell" {{ old('equipment_needed') == 'Kettlebell' ? 'selected' : '' }}>{{ __('Kettlebell') }}</option>
                                <option value="Machine" {{ old('equipment_needed') == 'Machine' ? 'selected' : '' }}>{{ __('Machine') }}</option>
                                <option value="Cable" {{ old('equipment_needed') == 'Cable' ? 'selected' : '' }}>{{ __('Cable') }}</option>
                                <option value="Resistance Band" {{ old('equipment_needed') == 'Resistance Band' ? 'selected' : '' }}>{{ __('Resistance Band') }}</option>
                                <option value="Other" {{ old('equipment_needed') == 'Other' ? 'selected' : '' }}>{{ __('Other') }}</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="difficulty_level" id="difficulty_level" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500 focus:ring-opacity-50" required>
                                ...
                                <option value="Intermediate" {{ old('difficulty_level') == 'Intermediate' ? 'selected' : '' }}>{{ __('Intermediate') }}</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="instructions" id="instructions" rows="4" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500 focus:ring-opacity-50" required>{{ old('instructions') }}</textarea>
                            @error('instructions')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Media Upload -->
                        <div class="md:col-span-2">
                            <label for="media" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Exercise Image (Optional)') }}</label>
